...
export interface SkincareRoutineScreenProps {
...
const routineOptions = [
  {
    ...
    label: "Yes, I have a morning and evening routine",
  },
  {
    value: "morning-only",
    label: "Only a morning routine",
  },
  {
    value: "evening-only",
    label: "Only an evening routine",
  },
  {
    value: "no-routine",
...
export function SkincareRoutineScreen({
  ...
  const handleNext = () => {
    if (selectedRoutine) {
      onNext({ skincareRoutine: selectedRoutine });
    }
  };
  ...
  return (
    <div className=" bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-8 pt-0">
        <div className="w-full max-w-lg space-y-8">
          ...
          <div className="space-y-4">
            {routineOptions.map((option) => (
              <button
                key={option.value}
                onClick={() => setSelectedRoutine(option.value)}
