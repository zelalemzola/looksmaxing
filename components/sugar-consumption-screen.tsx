...
export interface SugarConsumptionScreenProps {
...
export function SugarConsumptionScreen({
  onNext,
  onBack,
}: SugarConsumptionScreenProps) {
  const [selectedFrequency, setSelectedFrequency] = useState<string>("");

  const handleNext = () => {
    if (selectedFrequency) {
      onNext({ sugarConsumption: selectedFrequency });
    }
  };
        ...
        <div className="w-full max-w-lg space-y-8">
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600 text-sm">
              How often do you consume products with
              <br />
              added sugar, like sweets, coke, cookies,
              <br />
              etc?
            </p>
          </div>
